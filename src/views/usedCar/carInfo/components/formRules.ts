...
export default () => {
  const rules = reactive<FormRules>({
    ...
    displayImage: [{ required: true, trigger: 'change', message: '请上传显示图片' }],
    images: [{ required: true, trigger: 'change', message: '请上传图集' }],
    checkReports: [{ required: true, trigger: 'change', message: '请上传车检报告图集' }],
    appearances: [{ required: true, trigger: 'change', message: '请上传外观图集' }],
    interiors: [{ required: true, trigger: 'change', message: '请上传内饰图集' }],
    ...
    firstPlateTime: [{ required: true, trigger: 'change', message: '请输入首次上牌时间' }],
    transferNum: [{ required: true, trigger: 'change', message: '请输入过户次数' }],
    ...
    emissionStandard: [{ required: true, trigger: 'change', message: '请输入标准排量' }],
    drivingMeans: [{ required: true, trigger: 'change', message: '请输入驱动' }],
    downPayment: [{ required: true, trigger: 'change', message: '请输入首付' }],
    productionYear: [{ required: true, trigger: 'change', message: '请输入生产年份' }]
  })
  return rules
}
